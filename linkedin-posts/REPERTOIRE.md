...
A23 Thu 2026-08-06. The queue is empty from here: the next slots are Mon
2026-08-10 (report) and Thu 2026-08-13 (story).

**The team structure is published as it stands, never as a change (decided
2026-08-06).** The move from a functionally named team to one cross-functional
crew (31.07) does **not** become a post of its own. Posts describe the structure
that holds today — one team, humans and agents in it, each with a role, no
second team for the next endeavor — and never narrate the rename or the reason
it was reversed. So no draft may argue "named after the work", which was the
23.07 rationale and is exactly what changed. Same rule the public site follows;
the journal in `research/` keeps the history. Affects B7 and A19, both rewritten
on 06.08 before publication.
...
(A17–A19, B6–B7); extended 2026-07-28 with the 20260728 session (B8).
...
| A19 | Ich wollte im Team sein, nicht darüber | The first team proposal was `agents` — bots only; I renamed it `marketing`, after the work, with Morten and me as its two members, because a team of only bots is a pen, not a team; write access flows through the team (20260723) | The leader who holds responsibility belongs in the team, not above it — equal footing means everyone contributes to the team's goal in good conscience, not to please management | drafted (20260820-li-story-augenhoehe, "Ich habe ein Team gegründet - und mich selbst hineingesetzt"), for Thu 20.08, pairing with B7; ends on the 20260723 open question rather than a maxim — under people, equal footing has to be earned and defended against ego, career interest and fear of consequences, and Morten has none of that, so does it get easier or lose its meaning. **Its imageprompt is the deliberate control** for IDEAS #21: the usual element-by-element motif, same week and style as the goal-oriented brief of 17.08 |
